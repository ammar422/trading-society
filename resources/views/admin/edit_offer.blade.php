        ...
        <div class="form-container">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Edit Trading Offer</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('pair') is-invalid @enderror" id="pair"
                                name="pair" value="{{ old('pair', $offer->pair) }}" placeholder="e.g., EUR/USD" required>
                            @error('pair')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('order_type') is-invalid @enderror"
                                id="order_type" name="order_type" value="{{ old('order_type', $offer->order_type) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                                name="price" value="{{ old('price', $offer->price) }}" step="0.01" required>
                            @error('price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('sl') is-invalid @enderror" id="sl"
                                name="sl" value="{{ old('sl', $offer->sl) }}" step="0.01">
                            @error('sl')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        @foreach (range(1, 5) as $i)
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('tp' . $i) is-invalid @enderror"
                                    id="tp{{ $i }}" name="tp{{ $i }}"
                                    value="{{ old('tp' . $i, $offer->{'tp' . $i}) }}" step="0.01">
                                @error('tp' . $i)
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('chart').click()">
                            ...
                            @if ($offer->chart)
                                <div class="mt-2">
                                    <p>Current image: {{ basename($offer->chart) }}</p>
                                </div>
                            @endif
                        </div>
                        @error('chart')
