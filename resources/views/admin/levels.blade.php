            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Levels table</h6>
                    </div>
                    <br>
                    <style>
                        .left-align {
                    ...
                    <div class="col-6 left-align">
                        <a class="btn bg-gradient-dark mb-0" href="{{ route('admin.levels.create') }}">
                            <i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Level
                        </a>
                    </div>
                </div>
                                    ...
                                    @foreach ($levels as $level)
                                        <tr>
                                            ...
                                            <td @style('text-align:center')>
                                                <p class="text-xs text-secondary mb-0">{{ $level->order }}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <form action="{{ route('admin.levels.delete', $level->id) }}"
