                        ...
                        <div class="card wizard-card" data-color="purple" id="wizard">
                            <form action="{{ route('admin.levels.store') }}" method="POST"
                                ...
                                <div class="wizard-header">
                                    ...
                                    <h5>This information will appears In level Data.</h5>
                                </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="location">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h4 class="info-text"> Add basic details</h4>
                                            </div>
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Level Order</label>
                                ...
                                <div class="wizard-footer">
                                    <div class="pull-right">
                                        <input role="button" type="submit"
                                            class='btn btn-finish btn-fill btn-success btn-wd' name='update'
                                            value='Finish' />
                                    </div>
                                    <div class="pull-left">
                                        <a class='btn btn-danger btn-wd' href="{{ route('admin.levels') }}">Cancle</a>
                                    </div>
