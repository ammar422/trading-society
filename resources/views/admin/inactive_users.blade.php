            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">All In-Active Users table</h6>
                    </div>
                    <br>
                    <style>
                        .left-align {
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center" @style('text-align:center')>
                                                <span class="text-danger text-xs font-weight-bold">{{ $user->broker }}</span>
                                            </td>
                                            <td class="align-middle text-center" @style('text-align:center')>
                                                <span class="text-danger text-xs font-weight-bold">{{ $user->country }}</span>
                                            </td>
