<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://tradingsociety.net/" target="_blank">
            <img src="/admin-assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold text-white">Trading Society WebSite</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('admin.super_admin.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Super Admin</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('admin.instructor') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="">
                    ...
                    <span class="nav-link-text ms-1">Live Sessions</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('admin.offers') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">local_offer</i>
                    </div>
                    <span class="nav-link-text ms-1">Deals Posts</span>
                </a>
            </li>
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-primary mt-4 w-100" href="{{ route('instructor.dashboard') }}" type="button">
