                        ...
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                ...
                                <p class="text-sm mb-0">
                                    ...
                                    <span class="font-weight-bold ms-1">{{ $courses->count() }} courses</span> Until now
                                </p>
                            </div>
                                    ...
                                    @isset($courses)
                                        @foreach ($courses as $course)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span class="text-xs font-weight-bold">{{ $course->category->name }}
                                                    </span>
                                                </td>
                                            </tr>
                                        @endforeach
                ...
                <div class="card h-100">
                    <div class="card-header pb-0">
                        ...
                        <p class="text-sm">
                            ...
                            <span class="font-weight-bold">{{ $levels->count() }} Levels</span> Until now
                        </p>
                    </div>
                    @isset($levels)
                                ...
                                @foreach ($levels as $level)
                                    <div class="timeline-block mb-3">
                                        ...
                                        <div class="timeline-content">
                                            <h6 class="text-dark text-sm font-weight-bold mb-0">level name :
                                                {{ $level->name }}</h6>
                                            <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">level order
                                                :{{ $level->order }}</p>
                                        </div>
                                    </div>
                                @endforeach
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-4 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="" class="font-weight-bold" target="_blank"> EPIK Software</a>
                            for a better web.
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                            <li class="nav-item">
                                <a href="" class="nav-link text-muted" target="_blank">EPIK Software</a>
                            </li>
                            <li class="nav-item">
