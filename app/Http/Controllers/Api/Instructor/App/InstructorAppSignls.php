...
class InstructorAppSignls extends \Lynx\Base\Api
{
    ...
    {
        return $type == 'store' ? [
            'order_status'     => 'sometimes|nullable|in:bending,active,deleted,hit_sl,hit_tp1,hit_tp2,hit_tp3,hit_tp4,hit_tp5',
            'pair'             => 'sometimes|nullable|string|max:255',
            'price'            => 'sometimes|nullable|numeric|min:0',
            'order_type'       => 'sometimes|nullable|string|max:255',
            'sl'               => 'sometimes|nullable|numeric',
            'tp1'              => 'sometimes|nullable|numeric',
            'tp2'              => 'sometimes|nullable|numeric',
            'tp3'              => 'sometimes|nullable|numeric',
            'tp4'              => 'sometimes|nullable|numeric',
            'tp5'              => 'sometimes|nullable|numeric',
