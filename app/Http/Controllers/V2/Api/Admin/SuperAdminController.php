...
class SuperAdminController extends \Lynx\Base\Api
{
    protected $entity               = SuperAdmin::class;
    protected $resourcesJson        = SuperAdminResource::class;
    protected $policy               = SuperAdminPolicy::class;
    ...
    public function rules(string $type, mixed $id = null): array
    {
        ...
        return $type == 'store' ? [
            ...
            'name'      => 'required|string',
            'email'     => 'required|email|unique:super_admins,email,' . request('id'),
    ...
    {
        return new SuperAdminResource($entity);
    }
